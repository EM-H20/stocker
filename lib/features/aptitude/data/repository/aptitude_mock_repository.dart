...
class AptitudeMockRepository implements AptitudeRepository {
  ...
  Future<List<AptitudeTypeSummary>> getAllTypes() async {
    await Future.delayed(const Duration(milliseconds: 300));
    return [
      AptitudeTypeSummary(typeCode: 'STABLE', typeName: '안정 추구형', description: '원금 손실을 최소화하는 보수적 투자자'),
      AptitudeTypeSummary(typeCode: 'AGGRESSIVE', typeName: '단기 집중형', description: '단기간에 높은 수익을 추구하는 공격적 투자자'),
      AptitudeTypeSummary(typeCode: 'NEUTRAL', typeName: '위험 중립형', description: '안정성과 수익성의 균형을 맞추는 투자자'),
      AptitudeTypeSummary(typeCode: 'LONG_TERM', typeName: '장기 성장형', description: '장기적인 관점에서 꾸준한 성장을 추구하는 투자자'),
    ];
  }
  @override
  ...
  AptitudeResult _getDummyResult() {
    return AptitudeResult(
      typeName: '단기 집중 투자자',
      typeDescription: '단기 집중 투자자는 시장의 흐름을 빠르게 파악하고, 단기간에 높은 수익을 목표로 하는 적극적인 투자 성향을 가집니다. 변동성이 큰 자산에 대한 이해도가 높으며, 빠른 의사결정을 통해 기회를 포착하는 데 능숙합니다.',
      master: InvestmentMaster(
        name: '워렌 버핏',
        imageUrl: 'https://placehold.co/100x100/EFEFEF/AAAAAA&text=Master', // Placeholder image
        description: '오마하의 현인이라 불리는 워렌 버핏은 가치 투자의 대가입니다. 그는 기업의 내재 가치를 분석하여 저평가된 주식을 장기간 보유하는 전략으로 유명합니다.',
        portfolio: {
          'Apple (AAPL)': 45.0,
